    ...
    <div class="mt-3 mb-3">
        ...
        <form action="/admin/noticias/{{ $noticia->id }}/edit" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                ...
                <input type="date time-local" id="data" name="data" value="{{ old('data', $noticia->data) }}" class="form-control @error('data') is-invalid @enderror">
                @if($errors->has('data'))
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" id="titulo" name="titulo" value="{{ old('titulo', $noticia->titulo) }}" class="form-control @error('titulo') is-invalid @enderror">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" id="subtitulo" name="subtitulo" value="{{ old('subtitulo', $noticia->subtitulo) }}" class="form-control @error('subtitulo') is-invalid @enderror">
            ...
            <div class="form-group mb-2">
                ...
                <textarea id="texto" name="texto" class="form-control @error('texto')
                 is-invalid @enderror">{{ old('texto', $noticia->texto) }}</textarea>
                @if($errors->has('texto'))
                <div class="text-danger">
                    {{ $errors->first('texto') }}
                </div>
            ...
            <div class="form-group mb-2">
                ...
                <select name="id_autor" id="id_autor" class="form-control @error('id_autor') is-invalid @enderror">
                    ...
                    <option value="{{ $autor->id }}" {{old('id_autor', $noticia->id_autor) == $autor->id? 'selected' : ''}}>{{ $autor->nome }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group mb-2">
                ...
                <select name="id_caderno" id="id_caderno" class="form-control @error('id_caderno') is-invalid @enderror">
                    ...
                    <option value="{{ $caderno->id }}" {{old('id_caderno', $noticia->id_caderno) == $caderno->id? 'selected' : ''}}>{{ $caderno->nome }}</option>
                    @endforeach
                </select>
